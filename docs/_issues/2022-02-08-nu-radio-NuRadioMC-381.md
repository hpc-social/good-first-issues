...
Some of the antenna models in https://nu-radio.github.io/NuRadioMC/NuRadioReco/pages/detector/antennamodels.html d are outdated. A quick grep on the antenna model server gives this list of pkl files:
```
bicone_v8_InfAir
bicone_v8_InfFirn
bicone_v8_inf_n1.32
...
SKALA_InfFirn
trislot_RNOG
XFDTD_Hpol_150mmHole_n1.78_v3_air_rescaled_to_n1.74
